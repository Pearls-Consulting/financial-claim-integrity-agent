...
const EVIDENCE_LABELS: Record<string, { en: string; ar: string }> = {
  ...
  coc_ref: { en: "COC: claim / invoice ref.", ar: "المحضر: رقم المطالبة المالية" },
  coc_net: { en: "COC: net (excl. VAT)", ar: "المحضر: المبلغ قبل الضريبة" },
  invoice_net: { en: "Invoice: net (excl. VAT)", ar: "الفاتورة: المبلغ قبل الضريبة" },
  coc_vat: { en: "COC: VAT", ar: "المحضر: الضريبة" },
  invoice_vat: { en: "Invoice: VAT", ar: "الفاتورة: الضريبة" },
  coc_payment: { en: "COC: payment no.", ar: "المحضر: ترتيب الدفعة" },
  claim_payment_no: { en: "Claim: payment no.", ar: "المطالبة: رقم الدفعة" },
  coc_claim_type: { en: "COC: claim type", ar: "المحضر: نوع المستخلص" },
  coc_value_with_vat: { en: "COC: contract value (incl. VAT)", ar: "المحضر: قيمة العقد شامل الضريبة" },
  contract_value_with_vat: { en: "Contract value (incl. VAT)", ar: "قيمة العقد شامل الضريبة" },
  coc_end_date: { en: "COC: contract end date", ar: "المحضر: تاريخ نهاية العقد" },
  coc_award_letter: { en: "COC: award letter no.", ar: "المحضر: رقم خطاب الترسية" },
  award_letter: { en: "Filed award letter no.", ar: "رقم خطاب الترسية المرفق" },
